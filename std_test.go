...
func (tc stdLogSinkFlagsTestCase) Test(t *testing.T) {
	...
	core.AssertMustEqual(t, true, strings.Contains(message, "TEST:"), "message contains prefix")
	core.AssertEqual(t, true, strings.Contains(message, "test message"), "message contains text")
}
