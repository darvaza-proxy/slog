...
func runTestFieldsFilterWithStack(t *testing.T) {
	...
	core.AssertEqual(t, "value", msg.Fields["key"], "field key")
	core.AssertEqual(t, true, msg.Fields["filter_called"], "filter was called")
}
...
func runTestFieldsFilterEmptyMapOptimization(t *testing.T) {
	...
	msgs := base.GetMessages()
	core.AssertEqual(t, 1, len(msgs), "message should still be logged")
	...
	msgs = base.GetMessages()
	core.AssertEqual(t, 2, len(msgs), "both messages logged")
