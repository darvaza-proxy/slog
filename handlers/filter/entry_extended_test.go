...
func TestLogEntryOverridesExtended(t *testing.T) {
	t.Run("FieldOverridePreventsFurtherProcessing", testLogEntryFieldOverridePreventsFurtherProcessing)
	t.Run("FieldsOverrideWithFieldOverride", testLogEntryFieldsOverrideWithFieldOverride)
	t.Run("FieldsOverridePreventsFurtherProcessing", testLogEntryFieldsOverridePreventsFurtherProcessing)
}

func testLogEntryFieldOverridePreventsFurtherProcessing(t *testing.T) {
	base := newTestLogger()
...
func testLogEntryFieldsOverrideWithFieldOverride(t *testing.T) {
	base := newTestLogger()
...
func testLogEntryFieldsOverridePreventsFurtherProcessing(t *testing.T) {
	base := newTestLogger()
