...
func TestSink(t *testing.T) {
	...
	t.Run("V-Levels", func(t *testing.T) {
		...
		// V(0) should map to Info (not Warn anymore)
...
// TestSinkDisabled tests Sink behavior with disabled and nil loggers
...
// testDisabledLogger tests behavior when logger is disabled
...
// testWithEnabledDisabled verifies WithEnabled behavior for disabled loggers
...
// testNilLogger tests behavior with nil loggers
...
// TestConcurrency tests concurrent access to the logger
